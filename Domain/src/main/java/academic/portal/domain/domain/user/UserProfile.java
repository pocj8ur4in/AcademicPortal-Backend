...
public class UserProfile {
    ...
    @Lob // @Lob : DB에서 LOB 자료형인 CLOB, BLOB 사용 (<#> 참고 : https://m.blog.naver.com/skygrab/30102791739 / https://kogle.tistory.com/250)
    ...
    @Column
    private String profile_addr;

    @Column
    private String profile_birth;

    @Builder
    public UserProfile(String profile_username, String profile_realname, String profile_pfp, String profile_phone, String profile_mail, String profile_addr, String profile_birth) {
